...
export const usePlanStore = create<State>((set, get) => ({
  plan: {
    ...
    room: { W: 10000, H: 7000 },
    objects: [
      { id: 'cab-1', type: 'cabinet', rect: { X: 3900, Y: 6400, W: 1400, H: 600 }, properties: [], requiresWallAnchor: true },
      { id: 'cab-2', type: 'cabinet', rect: { X: 5500, Y: 6400, W: 1300, H: 600 }, properties: [], requiresWallAnchor: true },
      { id: 'col-1', type: 'column', rect: { X: 2300, Y: 1800, W: 1000, H: 1000 }, properties: [] },
      { id: 'col-2', type: 'column', rect: { X: 6700, Y: 1800, W: 1000, H: 1000 }, properties: [] },
      { id: 'door-1', type: 'door', rect: { X: 1500, Y: 6800, W: 1200, H: 200 }, properties: [], requiresWallAnchor: true },
      { id: 'esh-1', type: 'electrical_shield', rect: { X: 7300, Y: 6800, W: 800, H: 200 }, properties: [], requiresWallAnchor: true },
      ...
      { id: 'net-1', type: 'net_cabinet', rect: { X: 8300, Y: 6400, W: 800, H: 600 }, properties: [], requiresWallAnchor: true },
      { id: 'win-1', type: 'window', rect: { X: 1600, Y: 0, W: 2000, H: 200 }, properties: [], requiresWallAnchor: true },
